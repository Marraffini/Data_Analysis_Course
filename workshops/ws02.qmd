...
Explore multiple `geom`s and think about how different types of data might be displayed in each.
...
b) Make a summary dataset, present the average `prestige` for each type of occupation.
