...
[*R*](https://en.wikipedia.org/wiki/R_(programming_language)) is a software created in the 90s as an alternative to S, a propietary statsitical software. It was developed at the University of Auckland.

[*Rstudio*](https://en.wikipedia.org/wiki/RStudio) is a Graphic User Interface (GUI) for R developed by [*Posit*](https://posit.co/about).

Both software are approved by the [Libre software foundation](https://www.fsf.org/about/what-is-free-software)
...
## Exercise 1.4 {-}
Explore the help menu for the function `boxplot`. What line of code can you use to access this file?
...
## Exercise 1.5 {-}
Write code to generate an example of the function `boxplot` using a built in dataset `InsectSprays`. You can use `?InsectSprays` to find out more about this data.
...
## Exercise 1.6 {-}
How would you generate a horizontal boxplot? Use the help menu to find the argument you might need to change and what you would change it to. Explain in words and then in code.
...
## Exercise 1.7 {-}
Use your answers to the previous three exercises to write a short description of what the function `boxplot` does. Include what information you need to put into the function and what you might expect it to return.
