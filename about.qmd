...
This site contains materials for 161250 Data Analysis, including the [lecture slides](slides.qmd), [study guide](studyguide/index.qmd), [workshop code](workshops/ws01.qmd), and some extra code. The material is organised into 9 chapters, and all provided on one website for ease of access. Make use of the search function (using the magnifying glass icon on the top-right of the page)—it will allow you to quickly locate any text you enter across the whole site.
...
This course and subsequent iterations was developed, written, and managed by several staff at Massey University including Drs. Raj Govindaraju; Debbie Leader; Michelle Marraffini; Sergio Sclovich and Adam Smith.